#料品维度列表过滤
delete from pb_meta_filters where filterDesc='料品维度列表过滤';
...
values (@filtersolutionid,'SA_sa_basearchive_inventoryDimensionlist','料品维度列表过滤','SA','2016-12-07 14:01:56',0,0);
update bill_base set cFilterId=@filtersolutionid where cBillNo='sa_basearchive_inventoryDimensionlist';
