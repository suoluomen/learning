#退货出库单列表过滤
delete from pb_meta_filters where filterDesc='退货出库单列表过滤';
...
values (@filtersolutionid,'PU_pu_outlist','退货出库单列表过滤','PU','2016-12-07 14:01:56',0,0);
update bill_base set cFilterId=@filtersolutionid where cBillNo='pu_outlist';
